...
IF (NOT WIN32)
   ...
   PKG_SEARCH_MODULE( NETWORKMANAGER libnm REQUIRED)
   PKG_SEARCH_MODULE( NM-UTIL libnm-util REQUIRED)
ENDIF (NOT WIN32)

IF (NETWORKMANAGER_FOUND AND NM-UTIL_FOUND)
   IF (NOT NetworkManager_FIND_QUIETLY)
      MESSAGE(STATUS "Found NetworkManager ${NETWORKMANAGER_VERSION}: ${NETWORKMANAGER_LIBRARY_DIRS}: ${NETWORKMANAGER_LIBRARIES}")
