...
IF (NETWORKMANAGER_INCLUDE_DIRS AND NM-UTIL_INCLUDE_DIRS)
   # in cache already
   SET(NetworkManager_FIND_QUIETLY FALSE)
...
IF (NETWORKMANAGER_FOUND AND NM-UTIL_FOUND)
   IF (NOT NetworkManager_FIND_QUIETLY)
      MESSAGE(STATUS "Found NetworkManager ${NETWORKMANAGER_VERSION}: ${NETWORKMANAGER_LIBRARY_DIRS}: ${NETWORKMANAGER_LIBRARIES} in ${NETWORKMANAGER_INCLUDE_DIRS}")
      MESSAGE(STATUS "Found libnm-util: ${NM-UTIL_LIBRARY_DIRS} in ${NM-UTIL_INCLUDE_DIRS}")
